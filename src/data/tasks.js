export const tasks = [
  ...
  },
  {
    ...
    htmlContent: `
			<p>У їдальні пиріжок коштує <i>uah</i> гривень і <i>kop</i> копійок. Завдання – визначити, скільки гривень і
				копійок потрібно заплатити за <i>n</i> пиріжків.</p>
			<p>Програма повинна вивести два числа: вартість покупки у гривнях та копійках. Копійки не повинні
				перевищувати
				99.</p>
			<pre>	<b>Приклад 1:</b>
		<b>Вхід:</b>  uah = 10 kop = 15 n = 2
		<b>Вихід:</b> [20, 30]
	<b>Приклад 2:</b>	
		<b>Вхід</b> uah = 2 kop = 50 n = 4
		<b>Вихід:</b> [10, 0]
			</pre>
	  `,
    arg: 'uah, kop, n',
    execute: (myEqual, f) => {
      myEqual(f(10, 15, 2), [20, 30], '10 15 2 => [20, 30]');
      myEqual(f(2, 50, 4), [10, 0], '2, 50, 4 => [10, 0]');
      myEqual(f(0, 99, 1), [0, 99], '0 99 1 => [0, 99]');
      myEqual(f(0, 99, 2), [1, 98], '0 99 2 => [1, 98]');
      myEqual(f(1, 0, 1000), [1000, 0], '1 0 1000 => [1000, 0]');
      myEqual(f(5, 25, 10), [52, 50], '5 25 10 => [52, 50]');
      myEqual(f(9, 99, 1), [9, 99], '9 99 1 => [9, 99]');
      myEqual(f(9, 99, 2), [19, 98], '9 99 2 => [19, 98]');
      myEqual(f(0, 1, 100), [1, 0], '0 1 100 => [1, 0]');
    }
  },
  {
    id: 1_3,
